  ...
  return (
    <>
      <main>
        ...
        <div>+91 8334038440</div>

        <div>rajdeepbanikcontact@gmail.com</div>
        <br></br>
        <div>
          Designed by <span className="username">Lusine Baghdasaryan </span> and build with{" "}
          <span className="username">React.js </span>{" "}
        </div>
      </main>
    </>
  );
